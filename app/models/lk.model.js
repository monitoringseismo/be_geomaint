...
class LK {
    ...
    async insert(data){
        ...
        const result = await db.collection('laporan_kerusakan').insertOne(data);
    ...
    async show(id){
        const db = await this.getInstance();
        const result = await db.collection('laporan_kerusakan').findOne({_id:new ObjectId(id), deleted_at:{$exists:false}});
        return result;
    }
    ...
    async update(id, upd){
        ...
        await db.collection('laporan_kerusakan').updateOne(id,upd);
    ...
    async delete(id){
        ...
        const result = await db.collection('laporan_kerusakan').updateOne({_id:new ObjectId(id), deleted_at:{$exists : false}},update);
